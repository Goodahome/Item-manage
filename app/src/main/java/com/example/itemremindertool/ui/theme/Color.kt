...
// 深色主题
val ColdBluePrimaryDark = Color(0xFF4D94FF)
val ColdBlueSecondaryDark = Color(0xFF4D7FE6)
val ColdBlueTertiaryDark = Color(0xFFFF6B6B)
val ColdBluePrimaryContainerDark = Color(0xFF0040B2)
val ColdBlueBackgroundDark = Color(0xFF0B1120)
val ColdBlueSurfaceDark = Color(0xFF1E293B)
val ColdBlueSurfaceVariantDark = Color(0xFF2D3748)
